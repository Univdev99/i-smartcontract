...
contract BEP20WithCap is BEP20Capped, Ownable {
    constructor(string memory name_, string memory symbol_, uint256 cap_) BEP20(name_, symbol_) BEP20Capped(cap_) public {}
