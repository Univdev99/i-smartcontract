 ...
 * _Available since v3.4._
 */
abstract contract BEP20Permit is BEP20, IBEP20Permit, BIP712 {
...
contract BEP20PermitPausable is BEP20Permit, Ownable, BEP20Pausable, AccessControl {
    bytes32 public constant OPERATOR_ROLE = keccak256("OPERATOR_ROLE");
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");

    constructor(string memory name_, string memory symbol_) public BEP20Permit(name_) BEP20(name_, symbol_) {
     ...
     */
    modifier onlyAdmin() {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "BEP20PermitPausable: not admin");
        _;
    }
    ...
    modifier onlyOperator() {
        require(hasRole(OPERATOR_ROLE, _msgSender()), "BEP20PermitPausable: not operator");
        _;
    }
     ...
     */
    modifier onlyPauser() {
        require(hasRole(PAUSER_ROLE, _msgSender()), "BEP20PermitPausable: not pauser");
        _;
    }
    ...
    /**
     * @dev BEP20Pausable._beforeTokenTransfer(from, to, amount) override.
     * @param from address
     * @param to address
     * @param amount uint256
     */
    function _beforeTokenTransfer(
        ...
        address to,
        uint256 amount
    ) internal override(BEP20, BEP20Pausable) {
        super._beforeTokenTransfer(from, to, amount);
    }
