...
contract PriceCappedBNFT2 is BEP721, Ownable, AccessControl {
    ...
    constructor (
        ...
        public
        BEP721(name_, symbol_)
    {
        require(cap_ > 0, "PriceCappedBNFT2: cap is 0");
        _cap = cap_;
     ...
     */
    modifier onlyAdmin() {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "PriceCappedBNFT2: not admin");
        _;
    }
    ...
    modifier onlyOperator() {
        require(hasRole(OPERATOR_ROLE, _msgSender()), "PriceCappedBNFT2: not operator");
        _;
    }

    modifier onlyExistentToken(uint256 tokenId) {
        require(_exists(tokenId), "PriceCappedBNFT2: nonexistent token");
        _;
    }

    modifier onlyTokenOwner(uint256 tokenId) {
        require(ownerOf(tokenId) == _msgSender(), "PriceCappedBNFT2: not token owner");
        _;
    }
    ...
    function addOperator(
        ...
        onlyAdmin
    {
        require(!checkOperator(account), "PriceCappedBNFT2: already operator");
    ...
    function removeOperator(
        ...
        onlyAdmin
    {
        require(checkOperator(account), "PriceCappedBNFT2: not operator");
    ...
    {
        _tokenIds.increment();
        require(_tokenIds.current() <= _cap, "PriceCappedBNFT2: cap overflow");
    ...
    function applyOffer(
        ...
        payable
    {
        require(msg.value == _tokenPrice, "PriceCappedBNFT2: not enough fund");
        require(offers[offerId].isOpen, "PriceCappedBNFT2: offer closed");
