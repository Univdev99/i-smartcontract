...
contract PriceCappedBNFT3 is BEP721, Ownable, AccessControl {
    ...
    {
        require(cap_ > 0, "PriceCappedBNFT3: cap is 0");
        _cap = cap_;
     ...
     */
    modifier onlyAdmin() {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "PriceCappedBNFT3: not admin");
        _;
    }
    ...
    modifier onlyOperator() {
        require(hasRole(OPERATOR_ROLE, _msgSender()), "PriceCappedBNFT3: not operator");
        _;
    }

    modifier onlyExistentToken(uint256 tokenId) {
        require(_exists(tokenId), "PriceCappedBNFT3: nonexistent token");
        _;
    }

    modifier onlyTokenOwner(uint256 tokenId) {
        require(ownerOf(tokenId) == _msgSender(), "PriceCappedBNFT3: not token owner");
        _;
    }
    ...
    function addOperator(
        ...
        onlyAdmin
    {
        require(!checkOperator(account), "PriceCappedBNFT3: already operator");
    ...
    function removeOperator(
        ...
        onlyAdmin
    {
        require(checkOperator(account), "PriceCappedBNFT3: not operator");
        ...
        returns (uint256)
    {
        ...
        require(currentSupply <= _cap, "PriceCappedBNFT3: cap overflow");
    ...
    {
        _tokenIds.increment();
        require(_tokenIds.current() <= _cap, "PriceCappedBNFT3: cap overflow");
    ...
    function applyOffer(
        ...
        payable
    {
        require(msg.value == offers[offerId].price, "PriceCappedBNFT3: not enough fund");
        require(offers[offerId].isOpen, "PriceCappedBNFT3: offer closed");
