...
contract PriceCappedBNFT1 is BEP721, Ownable, AccessControl {
    ...
    {
        require(cap_ > 0, "PriceCappedBNFT1: cap is 0");
        _cap = cap_;
     ...
     */
    modifier onlyAdmin() {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "PriceCappedBNFT1: not admin");
        _;
    }
    ...
    modifier onlyOperator() {
        require(hasRole(OPERATOR_ROLE, _msgSender()), "PriceCappedBNFT1: not operator");
        _;
    }

    modifier onlyExistentToken(uint256 tokenId) {
        require(_exists(tokenId), "PriceCappedBNFT1: nonexistent token");
        _;
    }

    modifier onlyTokenOwner(uint256 tokenId) {
        require(ownerOf(tokenId) == _msgSender(), "PriceCappedBNFT1: not token owner");
        _;
    }
    ...
    function addOperator(
        ...
        onlyAdmin
    {
        require(!checkOperator(account), "PriceCappedBNFT1: already operator");
    ...
    function removeOperator(
        ...
        onlyAdmin
    {
        require(checkOperator(account), "PriceCappedBNFT1: not operator");
    ...
    {
        _tokenIds.increment();
        require(_tokenIds.current() <= _cap, "PriceCappedBNFT1: cap overflow");
    ...
    function applyOffer(
        ...
        payable
    {
        require(msg.value == offers[offerId].price, "PriceCappedBNFT1: not enough fund");
        require(offers[offerId].isOpen, "PriceCappedBNFT1: offer closed");
