...
contract BNFT is BEP721, Ownable, AccessControl {
     ...
     */
    modifier onlyAdmin() {
        require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "BNFT: not admin");
        _;
    }
    ...
    modifier onlyOperator() {
        require(hasRole(OPERATOR_ROLE, msg.sender), "BNFT: not operator");
        _;
    }
    ...
    function setTokenURI(uint256 tokenId, string memory tokenURI) public virtual onlyOperator {
        require(_exists(tokenId), "BNFT: URI set of nonexistent token");
