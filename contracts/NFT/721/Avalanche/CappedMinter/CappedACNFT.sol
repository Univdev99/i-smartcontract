...
contract CappedACNFT is ERC721, Ownable, AccessControl {
     ...
     */
    modifier onlyAdmin() {
        require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "CappedACNFT: not admin");
        _;
    }
    ...
    modifier onlyOperator() {
        require(hasRole(OPERATOR_ROLE, msg.sender), "CappedACNFT: not operator");
        _;
    }
